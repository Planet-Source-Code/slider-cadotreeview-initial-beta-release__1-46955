...
Begin VB.Form fAdoWrapper 
   ...
   Caption         =   "Demo01 : 2 Tables/Layers"
   ClientHeight    =   6840
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5145
...
'===========================================================================
'
' Form Name:    fAdoWrapper [Demo01 - 2 Layers]
' Author:       Graeme Grant        (a.k.a. Slider)
' Date:         10/07/2003
' Version:      00.01.00
' Description:  Test/Demo 1 - Products by Group
...
'
Private Const clPRODCOLOR  As Long = &H800080
Private Const clGROUPCOLOR As Long = &H40C0&
...
Private Sub pInit()
    ...
    With moTreeDB
        ...
        With .DataShape
            ...
            '
            With .Add("GRPPROD", "GroupA", "GP", "", True, clGROUPCOLOR, , True, 1, 3, 2)
                '
                ...
                .TableSort = "[Desc]"
                '
                '## Set the required RecordSet Field names
                '
                With .Fields
            ...
            '
            With .Add("PROD", "ProductA", "PR", "GRPPROD", , clPRODCOLOR, , , 4, 5)
                .TableSort = "[Desc]"
                With .Fields
                    .Item(efldID).Desc = "PkID"
                    .Item(efldDesc).Desc = "Desc"
