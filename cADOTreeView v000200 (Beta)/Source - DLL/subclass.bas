...
' Version:     01.01.00
' Description: Subclassing functionality
' Notes:       Adapted to work with the cLODTreeview wrapper DLL/Classes
'              -=-=-= Warning! =-=-=-
...
Sub AttachMessage(iwp As cLODTreeview, ByVal hwnd As Long, ByVal iMsg As Long)
...
Sub DetachMessage(iwp As cLODTreeview, ByVal hwnd As Long, ByVal iMsg As Long)
...
Private Function WindowProc(ByVal hwnd As Long, ByVal iMsg As Long, _
    ...
    Dim f          As Long
    Dim iwp        As cLODTreeview
    Dim iwpT       As cLODTreeview
    Dim iPC        As Long
    Dim iP         As Long
